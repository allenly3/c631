/* Hybrid reduction solution (single-kernel) : binary at the first
   level, atomic at the second.
*/
...
// Single step binary reduction:
__global__ void BinaryAtomicKernel ()
{
...
// Set d_A to zero on device:
  ...
  BinaryAtomicKernel <<<NBLOCKS, BLOCK_SIZE>>> ();
